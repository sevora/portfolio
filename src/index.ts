...
// this is an efficient viewport observer
...
/**
 * This is used to determine some parameters according to device.
 * @returns a boolean indicating if device is mobile or not.
 */
function isMobile() {
    let check = false;
