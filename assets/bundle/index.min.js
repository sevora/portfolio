...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _MapEmitterRenderer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MapEmitterRenderer.js */ \"./js/MapEmitterRenderer.js\");\n\nvar gradient = document.querySelector(\".gradient-layer\");\nvar canvas = document.querySelector(\".cover-layer\");\nvar mapEmitter = new _MapEmitterRenderer_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"../images/background/pattern-original-large.png\", [23, 23, 23], window, canvas);\nvar now = Date.now();\nvar then = now;\nvar fps = 60;\ncanvas.width = window.document.body.clientWidth;\ncanvas.height = window.document.body.clientHeight;\nmapEmitter.load(function () {\n  setup();\n  loop();\n});\nfunction loop() {\n  window.requestAnimationFrame(loop);\n  now = Date.now();\n  var elapsed = now - then;\n  var interval = 1000 / fps;\n  if (elapsed > interval) {\n    then = now - elapsed % interval;\n    update();\n    render();\n  }\n}\nfunction setup() {\n  gradient.style.visibility = \"visible\";\n  mapEmitter.setup();\n  console.log(mapEmitter);\n}\nfunction update() {\n  mapEmitter.update();\n}\nfunction render() {\n  mapEmitter.render();\n}\n\n//# sourceURL=webpack://portfolio/./js/index.js?");
